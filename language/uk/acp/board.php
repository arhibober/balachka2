...
$lang = array_merge($lang, array(
	...
	'ALLOW_AVATARS_EXPLAIN'		=> 'Дозволяє глобальне використання аватарів.<br />Якщо ви вимкните аватари в цілому або забороните використання деяких режимів аватар, то вимкнені аватари більше не будуть відображатися на форумі, але користувачі, як і раніше, зможуть завантажувати свої власні аватари в Панелі керування.',
...
$lang = array_merge($lang, array(
	...
	'BUMP_INTERVAL_EXPLAIN'	=> 'Кількість хвилин, годин або днів, яка повинна пройти з часу останнього повідомлення, щоб можна було піднімати цю тему. Значення 0 вимикає цю функцію.',
	...
	'MIN_CHAR_LIMIT_EXPLAIN' => 'Мінімальна кількість символів, яку повинен ввести користувач в повідомленні/приватному повідомленні.',
	'POSTING'	=> 'Повідомлень',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_EXPLAIN'	=> 'Визначає, чи користувач відразу отримує доступ до форуму чи необхідне підтвердження реєстрації. Також ви можете вимкнути нові реєстрації користувачів взагалі.',
