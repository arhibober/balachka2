...
$lang = array_merge($lang, array(
	...
	'OTHER_USERS'	=> 'Користувачі, які пишуть з цього IP',
 	...
 	'PM_REPORTED_SUCCESS' => 'Повідомлення щодо цого приватного повідомлення успішно відправлено.', 
 	'PM_REPORT_TOTAL' => 'Кількість скарг на приватні повідомлення: <strong>1</strong>.',
 	'PM_REPORTS_CLOSED_SUCCESS'	=> 'Обрані скраги на приватні повідомлення успішно закрито.',
 	'PM_REPORTS_DELETED_SUCCESS'=> 'Обрані скраги на приватні повідомлення успішно видалено.', 
